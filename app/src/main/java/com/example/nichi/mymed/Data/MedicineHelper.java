...
public class MedicineHelper extends SQLiteOpenHelper {
    ...
    public static final String LOG_TAG = MedicineHelper.class.getSimpleName();
    ...
    /**
     * Constructs a new instance of {@link MedicineHelper}.
     *
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(MedicineContract.MedicineEntery.createTable());
    }
